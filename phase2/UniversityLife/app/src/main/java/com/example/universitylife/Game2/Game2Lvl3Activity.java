...
public class Game2Lvl3Activity extends AppCompatActivity implements ILevel2.ILevel2View {
    private Game2Lvl3Presenter game2Presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        credit_tv = findViewById(R.id.credit_3);
        gpa_tv = findViewById(R.id.gpa_3);
        hp_tv = findViewById(R.id.hp_3);
        red = findViewById(R.id.red_3);
        blue = findViewById(R.id.blue_3);
        yellow = findViewById(R.id.yellow_3);
        whatyoushoulddo = findViewById(R.id.thingsYouShouldDo_2);
        ...
        this.game2Presenter = new Game2Lvl3Presenter(this, new DataHandler(this), username);
        initiateImageView();
    ...
    public void quitGame() {
        start = false;
        setScore();
        TextView textView = findViewById(R.id.final_score_3);
    ...
    public void setScore() {
        TextView textView = findViewById(R.id.score_3);
        textView.setText("Score:"+ game2Presenter.getScore());
    }

    @Override
    public void setSecondRemaining() {
        TextView seconds = findViewById(R.id.secondRemaining_3);
    ...
    public void displayName(String name) {
        TextView tv_userName = findViewById(R.id.userName_3);
