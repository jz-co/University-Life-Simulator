...
public class Game2Lvl4Activity extends AppCompatActivity implements ILevel2.ILevel2View {
    private Game2Lvl4Presenter game2Presenter;
    private TextView credit_tv, gpa_tv, hp_tv;
    private ImageView red, blue, yellow, whatyoushoulddo, whatyoushouldnotdo, killingObject, umbrella;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        whatyoushoulddo = findViewById(R.id.thingsYouShouldDo_3);
        whatyoushouldnotdo = findViewById(R.id.thingsYouShouldNotDo_3);
        umbrella = findViewById(R.id.umbrella_4);
        killingObject = findViewById(R.id.killingObject_2);
        this.game2Presenter = new Game2Lvl4Presenter(this, new DataHandler(this), username);
        initiateImageView();
    ...
    public void quitGame() {
        start = false;
        setScore();
        TextView textView = findViewById(R.id.final_score_4);
    ...
    public void setScore() {
        TextView textView = findViewById(R.id.score_4);
        textView.setText("Score:"+ game2Presenter.getScore());
    }

    @Override
    public void setSecondRemaining() {
        TextView seconds = findViewById(R.id.secondRemaining_4);
    ...
    public void displayName(String name) {
        TextView tv_userName = findViewById(R.id.userName_4);
    ...
    public void move_right(View view) {
        ...
        updateViewPosById(R.id.character_4);
    }
    ...
    public void start_game(View view) {
        ...
        killingObject.setVisibility(View.VISIBLE);
